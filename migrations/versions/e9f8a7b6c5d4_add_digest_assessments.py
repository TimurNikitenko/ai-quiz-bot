...
down_revision: Union[str, Sequence[str], None] = 'b8e2f9d10c4a'
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_digest_assessments_format_variant"),
        "digest_assessments",
        ["format_variant"],
        unique=False,
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index(
        op.f("ix_digest_assessments_format_variant"), table_name="digest_assessments"
    )
